...
class PaLiGemmaEndpointConstruct(Construct):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # TODO: Check if this should be using self.region
        image: str = (
            f"{self.account}.dkr.ecr.{self.region}.amazonaws.com/huggingface-pytorch-inference:2.1.0-transformers4.37.0-gpu-py310-cu118-ubuntu20.04"
        )
